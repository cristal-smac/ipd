...
## NEW : Notebook for journal Evolutionary Computation, ECJ (stochastic evolution)
English : [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/cristal-smac/ipd.git/master?filepath=FR/studiesOnStochasticEvolutions_fr.ipynb)
...
### Notebook for IEEE SMC Systems , fev 2023 (Softening and Hardening)
