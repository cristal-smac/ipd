...
This repository is a continuation of the old website [https://web.archive.org/web/1998*/www.lifl.fr/ipd](http://www.lifl.fr/IPD) created in 1998 and containing a simulator to carry out various experiments at the iterated prisoner's dilemma (thanks to the Wayback Machine). This repository has now been deleted to reappear here.
